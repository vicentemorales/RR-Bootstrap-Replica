...
function TopBar() {
  return (
    ...
    <Navbar bg="light" expand="lg" style={{ width: "100%", display: 'flex', flexDirection:"row", justifyContent:"space-between", outline: 'solid red' }}>


      <div style={{width: "45%", outline: 'solid red'}}>    
